...
export const ROUTES: RouteDef[] = [
  ...
  { path: "/way-of-life/our-beliefs", topic: "Our beliefs", cluster: "C", indexable: false, priority: 0.6, changefreq: "monthly" },
  { path: "/way-of-life/our-history", topic: "Our history", cluster: "C", indexable: false, priority: 0.6, changefreq: "monthly" },
  { path: "/way-of-life/our-network", topic: "Our network", cluster: "E", indexable: false, priority: 0.6, changefreq: "monthly" },
  { path: "/way-of-life/our-neighbours", topic: "Our neighbours", cluster: "C", indexable: false, priority: 0.6, changefreq: "monthly" },
